<template>
  <!--   <div
    ...
    style="width: 40rem;"
  > -->
  <!-- TODO: maybe make this use the same class as the normal navitem? -->
  <div
    class="mega-menu cursor-default transition duration-300 hover:opacity-100 group-hover:opacity-100 lg:block"
    style="width: 40rem"
    :class="isOpen ? 'block' : 'hidden'"
  >
    <div class="flex flex-col lg:flex-row px-8 py-6 border-b">
      <ul class="w-full lg:w-1/2">
        <li class="mb-6">
          <a
            href="/blog"
            class="flex p-2 text-blue-800 hover:text-primary-base"
          ...
          >
            ...
            <span class="ml-2">
              <span class="block font-bold flex items-center">
                <span>Law Enforcement</span>
                <b-badge class="brf-badge brf-badge-life ml-2"> New </b-badge>
              </span>
              <span class="block text-sm text-gray-600">
                Measure actions users take
              </span>
            </span>
          </a>
        </li>
        <li class="mb-6">
          ...
          >
            ...
            <span class="ml-2">
              <span class="block font-bold">Firefighters</span>
              <span class="block text-sm text-gray-600">
                Probably meant to click this one
              </span>
            </span>
          </a>
        </li>
        <li class="mb-6 lg:mb-0">
          ...
          >
            ...
            <span class="ml-2">
              <span class="block font-bold"> Non-Profit Organizations </span>
              <span class="block text-sm text-gray-600">
      ...
      <ul class="w-full lg:w-1/2">
        <li class="mb-6">
          ...
          >
            ...
            <span class="ml-2">
              <span class="block font-bold"> Commercial </span>
              <span class="block text-sm text-gray-600">
        ...
        <li>
          ...
          >
            ...
            <span class="ml-2">
              <span class="block font-bold">Professional Networks</span>
              <span class="block text-sm text-gray-600">
    ...
    <ul class="bg-charcoal-100 rounded-bl-lg rounded-br-lg px-8 py-8">
      <li class="mb-6">
        <a
          href="#"
          class="flex text-blue-800 hover:text-primary-base lg:items-center"
          @keydown.esc.exact="hideMenu"
          @keydown.tab.exact="focusNext(false)"
          @keydown.shift.tab="focusPrevious(false)"
          @keydown.up.exact.prevent="focusPrevious(true)"
        ...
        >
          ...
          <span class="flex flex-col lg:flex-row lg:items-center">
            <span class="block ml-2 font-bold"> Documentation </span>
            <span class="block ml-2 lg:ml-4 text-sm text-gray-600">
      ...
      <li class="mb-6">
        ...
        >
          ...
          <span class="flex flex-col lg:flex-row lg:items-center">
            <span class="block ml-2 font-bold"> Full API Reference </span>
            <span class="block ml-2 lg:ml-4 text-sm text-gray-600">
              Official libraries for our API
            </span>
          </span>
        </a>
      </li>
      <li>
        ...
        >
          ...
          <span class="flex flex-col lg:flex-row lg:items-center">
            <span class="block ml-2 font-bold"> Open Source </span>
            <span class="block ml-2 lg:ml-4 text-sm text-gray-600">
